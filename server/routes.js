 ...
 * @param {string} opts.ttlCacheControl Overrides the s-maxage value, the default value is set to 900 seconds
 */
exports.isomorphicRoutes = function isomorphicRoutes(
  ...
  if (redirectRootLevelStories) {
    app.get(
      "/:storySlug",
      withConfig(redirectStory, { logError, cdnProvider, ttlCacheControl })
    );
  }
