...
function loadDataForIsomorphicRoute(
  ...
  url,
  routes,
  { otherParams, config, client, host, logError }
) {
...
function loadDataForPageType(
  ...
  pageType,
  params,
  { config, client, logError, host }
) {
  return new Promise(resolve =>
    resolve(
      loadData(pageType, params, config, client, { host, next: abortHandler })
    )
  )
    .then(result => {
...
exports.handleIsomorphicShell = function handleIsomorphicShell(
  req,
  res,
  next,
  {
  ...
  if (
    req.query["_workbox-precaching"] &&
    req.query["_workbox-precaching"] != assetHelper.assetHash("app.js")
  )
  ...
  loadDataForPageType(
    ...
    "shell",
    {},
    { config, client, logError, host: req.hostname }
  ).then(result => {
    res.status(200);
...
exports.handleIsomorphicDataLoad = function handleIsomorphicDataLoad(
  ...
  function staticDataLoader() {
    ...
    if (match) {
      ...
      return loadDataForPageType(loadData, loadErrorData, pageType, params, {
        ...
        Object.assign(
          { pageType: pageType, disableIsomorphicComponent: true },
          result
        )
      );
    }
  ...
  function returnNotFound() {
    return new Promise(resolve =>
      resolve(loadErrorData(new NotFoundException(), config))
    )
...
exports.notFoundHandler = function notFoundHandler(
  ...
  res,
  next,
  { config, client, loadErrorData, renderLayout, pickComponent, logError }
) {
...
exports.handleIsomorphicRoute = function handleIsomorphicRoute(
  ...
  return loadDataForIsomorphicRoute(
    ...
    { config, client, logError, host: req.hostname, logError }
  )
    .catch(e => {
      logError(e);
      return { httpStatusCode: 500, pageType: "error" };
