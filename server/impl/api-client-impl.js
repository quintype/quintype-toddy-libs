const { Client, Story, Author, Static, Member, Collection, Entity } = require("quintype-backend");
...
module.exports = {getClientImpl, Client, Story, Author, Static, Member, Collection, Entity};
