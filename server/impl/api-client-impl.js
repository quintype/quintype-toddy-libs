const { Client, Story, Author, CustomPath, Member, Collection, Entity, MenuGroups } = require("@quintype/backend");
...
module.exports = {getClientImpl, Client, Story, Author, CustomPath, Member, Collection, Entity, MenuGroups};
