...
describe("AssetHelperImpl", function() {
  describe("assetPath", function() {
    const { assetPath } = new AssetHelperImpl(
      { asset_host: "//my-cdn" },
    ...
    it("overwrites asset path", function() {
      assert.equal(
        "/toddy/assets/app-03e7de595a129bb1ce20.js",
        assetPath("app.js", "")
      );
    });
  });
  ...
  describe("readAsset", function() {
    const { readAsset, serviceWorkerContents } = new AssetHelperImpl(
      { asset_host: "//my-cdn" },
      {
        "app.js": "/app.js",
    ...
    it("can read assets from the disk", function() {
      assert.equal(
        "Contents of public/serviceWorkerHelper.js",
  ...
  describe("get asset hash", function() {
    const { assetHash } = new AssetHelperImpl(
      { asset_host: "//my-cdn" },
      {
        "app.js": "/toddy/assets/app-03e7de595a129bb1ce20.js",
  ...
  describe("get all asset files", function() {
    const { assetFiles } = new AssetHelperImpl(
      { asset_host: "//my-cdn" },
      {
        "app.js": "/toddy/assets/app-03e7de595a129bb1ce20.js",
        "dev.js": "/toddy/assets/dev.js"
    ...
    it("returns a set of all files", function() {
      ...
      assert.equal(
        true,
        files.has("/toddy/assets/app-03e7de595a129bb1ce20.js")
      );
  ...
  describe("get files for a chunk", function() {
    ...
    it("has a css-path and css-content", function() {
      ...
      assert.equal(
        "//my-cdn/toddy/assets/list-abcd.css",
        chunk.cssFiles[0].path
      );
      assert.equal(
        "Contents of public/toddy/assets/list-abcd.css",
        chunk.cssFiles[0].content
      );
      assert.equal(
        "//my-cdn/toddy/assets/list~story-abcd.css",
        chunk.cssFiles[1].path
      );
    });
    ...
    it("has js-paths with related dependencies", function() {
      ...
      assert.equal(
        true,
        jsPaths.includes("//my-cdn/toddy/assets/list-abcd.js")
      );
      assert.equal(
        true,
        jsPaths.includes("//my-cdn/toddy/assets/vendors~list-abcd.js")
      );
      assert.equal(
        true,
        jsPaths.includes("//my-cdn/toddy/assets/vendors~list~story-abcd.js")
      );
      assert.equal(
        true,
        jsPaths.includes("//my-cdn/toddy/assets/vendors~story~list-abcd.js")
      );
      assert.equal(
        true,
        jsPaths.includes("//my-cdn/toddy/assets/list~story-abcd.js")
      );
      assert.equal(
        false,
        jsPaths.includes("//my-cdn/toddy/assets/list-abcd.js.map")
      ); // Map file
      assert.equal(
        false,
        jsPaths.includes("//my-cdn/toddy/assets/story-abcd.js")
      ); // different chunk
      assert.equal(
        false,
        jsPaths.includes("//my-cdn/toddy/assets/vendors~story-abcd.js")
      ); // different chunk
      assert.equal(
        false,
        jsPaths.includes("//my-cdn/toddy/assets/vendors~list-abcd.js.map")
      ); // Map file
      assert.equal(
        false,
        jsPaths.includes("//my-cdn/toddy/assets/list-abcd.css")
      ); // not JS
    });
    ...
    it("returns all the chunks", function() {
      ...
      assert.equal(
        "//my-cdn/toddy/assets/list-abcd.css",
        list.cssFiles[0].path
      );
      assert.equal(
        "//my-cdn/toddy/assets/story-abcd.css",
        story.cssFiles[0].path
      );
    });
